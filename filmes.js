...
function xmlQueryTopicos(xmlNode,identacao){
  ...
  if(topic_id_sem_hash=="animatrix"){
      document.write(`<div class="fita"><div class="conteudo">Animatrix</div></div>`);
      document.write("<div class='container'><b>Titulo:</b> Animatrix<br><br>");
      document.write("<b>Titulo Inglês:</b> Animatrix<br><br>");
      document.write("<b>Distribuição:</b> Seção não encontrada :(<br><br>");
      document.write("<b>Sinopse:</b> Seção não encontrada :(<br><br>");
      document.write("<b>Direção:</b> Seção não encontrada :(<br><br>");
      document.write("<b>Elenco:</b> Seção não encontrada :(<br><br>");
      document.write("<b>Elenco Apoio:</b> Seção não encontrada :(<br><br>");
      document.write("<b>Ano:</b> Seção não encontrada :(<br><br>");
      document.write("<b>Gênero:</b> Seção não encontrada :(<br><br>");
      document.write("<b>Site:</b> Seção não encontrada :(<br><br></div>");
      nao_achou=false;
  }else if(topic_id_sem_hash=="a-profecia"){
    document.write(`<div class="fita"><div class="conteudo">A Profecia</div></div>`);
    document.write("<div class='container'><b>Titulo:</b> A Profecia<br><br>");
    document.write("<b>Titulo Inglês:</b> The Omen<br><br>");
    document.write("<b>Distribuição:</b> Seção não encontrada :(<br><br>");
    document.write("<b>Sinopse:</b> Seção não encontrada :(<br><br>");
    document.write("<b>Direção:</b> Seção não encontrada :(<br><br>");
    document.write("<b>Elenco:</b> Seção não encontrada :(<br><br>");
    document.write("<b>Elenco Apoio:</b> Seção não encontrada :(<br><br>");
    document.write("<b>Ano:</b> Seção não encontrada :(<br><br>");
    document.write("<b>Gênero:</b> Terror<br><br>");
    document.write("<b>Site:</b> Seção não encontrada :(<br><br></div>");
    nao_achou=false;
  }else if(topic_id_sem_hash=="o-barco-do-amor"){
    document.write(`<div class="fita"><div class="conteudo">O Barco do Amor</div></div>`);
    document.write("<div class='container'><b>Titulo:</b> O Barco do Amor<br><br>");
    document.write("<b>Titulo Inglês:</b> Boat Trip<br><br>");
    document.write("<b>Distribuição:</b> Seção não encontrada :(<br><br>");
    document.write("<b>Sinopse:</b> Seção não encontrada :(<br><br>");
    document.write("<b>Direção:</b> Seção não encontrada :(<br><br>");
    document.write("<b>Elenco:</b> Seção não encontrada :(<br><br>");
    ...
    document.write(`<div class="fita"><div class="conteudo">Amigas para Sempre</div></div>`);
    document.write("<div class='container'><b>Titulo:</b> Amigas para Sempre<br><br>");
    document.write("<b>Titulo Inglês:</b> Crossroads<br><br>");
    document.write("<b>Distribuição:</b> Seção não encontrada :(<br><br>");
    document.write("<b>Sinopse:</b> Seção não encontrada :(<br><br>");
    document.write("<b>Direção:</b> Seção não encontrada :(<br><br>");
    document.write("<b>Elenco:</b> Britney Spears<br><br>");
    document.write("<b>Elenco Apoio:</b> Seção não encontrada :(<br><br>");
    document.write("<b>Ano:</b> Seção não encontrada :(<br><br>");
    document.write("<b>Gênero:</b> Seção não encontrada :(<br><br>");
    document.write("<b>Site:</b> Seção não encontrada :(<br><br></div>");
    ...
    document.write(`<div class="fita"><div class="conteudo">Coyote Bar</div></div>`);
    document.write("<div class='container'><b>Titulo:</b> Coyote Bar<br><br>");
    document.write("<b>Titulo Inglês:</b> Coyote Ugly<br><br>");
    document.write("<b>Distribuição:</b> Seção não encontrada :(<br><br>");
    document.write("<b>Sinopse:</b> Seção não encontrada :(<br><br>");
    document.write("<b>Direção:</b> Seção não encontrada :(<br><br>");
    document.write("<b>Elenco:</b> Seção não encontrada :(<br><br>");
